...
<body>
    <div class="bigbox">
            ...
            <div class = "sidebar" id="side_nav">
                ...
                <div>
                    <ul class="list-unstyled px-2">
                        <li class=""><a href ="driver.php" class="text-decoration-none px-3 py-2 d-block"><i class="fas fa-home"></i>Dashboard</li>
                        <li class="active"><a href ="dri_profile.php" class="text-decoration-none px-3 py-2 d-block"><i class="fa-solid fa-user"></i>Profile</li>
                        <li class=""><a href ="dri_drivers.php" class="text-decoration-none px-3 py-2 d-block"><i class="fas fa-users"></i>Drivers</li>                    </ul>
        ...
        <div class="rightside">
            ...
            <?php require_once("../dri_profile.php") ?>
